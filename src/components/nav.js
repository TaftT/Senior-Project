        ...
        return (
            <nav className='bg-white fixed w-full bottom-0' style={navStyle}>
                <div className='flex w-full justify-between'>
                    <a href="/myLocations" className="flex flex-col items-center justify-between cursor-pointer hover:bg-gray-100 w-1/3 p-2">
                    ...
                    <a href="/explore" className="flex flex-col items-center justify-between cursor-pointer hover:bg-gray-100 w-1/3 p-2">
                    ...
                    <a className="flex flex-col items-center justify-between cursor-pointer hover:bg-gray-100 w-1/3 p-2">
