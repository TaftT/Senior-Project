        ...
        return (
            ...
            <header className='bg-white  shadow-lg w-full p-2 flex justify-between items-center'>
                ...
                </Link>
                {
                    ...
                    <button className='rounded-md bg-sky-900 text-white font-bold p-2 w-3/12  hover:bg-sky-700' onClick={()=>{
                        this.logout()
                        
                    }}>Logout</button> 
                    :
                    <Link to="/login" className='w-3/12 flex justify-end'>
                        <button className='rounded-md bg-sky-900 text-white font-bold p-3  hover:bg-sky-700'>Login</button>
                    </Link>
                }
